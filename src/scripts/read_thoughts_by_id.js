...
pub fun main(address: Address, thoughtId: UInt64) : Thought? {
	let thoughts : [Thought] = [] 
		...
		let ref = cap.borrow()! 
		 let t = ref.borrowThoughtPublic(thoughtId)
   		 return getThought(t, withQuote: true)
}
